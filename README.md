## How to run
python flow --imgdir sample_img/ --model cfg/yolov2-tiny-voc.cfg --load bin/yolov2-tiny-voc.weights

## running from checkpoint
python flow --model cfg/yolov2-tiny-voc-1c.cfg --load -1 --imgdir sample_img/

## saving .pb file
python flow --model cfg/yolov2-tiny-voc-1c.cfg --load -1 --savepb

## How to train
python flow --model cfg/yolov2-tiny-voc-1c.cfg --load bin/yolov2-tiny-voc.weights --train --annotation train/annotations --dataset train/images --epochs 300
...
Python3, tensorflow 1.0, numpy, opencv 3, cython==0.29.21, protobuf==3.2.x
